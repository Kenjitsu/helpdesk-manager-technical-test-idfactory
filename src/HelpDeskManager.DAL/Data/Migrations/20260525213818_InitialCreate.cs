        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comments_SupportRequests_SupportRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangeNotes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestHistories_SupportRequests_SupportRequestId",
                        column: x => x.SupportRequestId,
                        principalTable: "SupportRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "45e21001-451d-46e6-a2a0-aeb61de41b65", null, "Agent", "AGENT" },
                    { "664d3e82-7b78-4b56-a7ff-f2ee0fb41f64", null, "Reader", "READER" },
                    { "8403bc3d-89b6-4190-b3a6-d41d57e7b03f", null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUsers_DocumentNumber",
                table: "AppUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_SupportRequestId",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestHistories_SupportRequestId",
